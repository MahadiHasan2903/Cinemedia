...
const Footer = () => {
  ...
  return (
    <div className="bg-[#000] text-white ">
      <div className="md:flex md:justify-between md:items-center sm:px-12 px-4 bg-[#938ed3] py-7 mt-[50px]">
        <h1 className="mb-6 text-3xl font-semibold lg:text-4xl md:mb-0 lg:leading-normal md:w-2/5">
          <span className="text-[#74aa48]">Subscribe</span> us for get news{" "}
          <br />
          events and offers
        </h1>
        <div>
      ...
      <div className="grid grid-cols-1 gap-6 px-5 py-16 sm:gird-cols-3 lg:grid-cols-4 sm:px-8 sm:text-center">
        ...
        <ul className="text-center sm:text-start">
          <h1 className="mb-1 font-semibold text-[25px]">Company</h1>
        ...
        <ul className="text-center sm:text-start">
          <h1 className="mb-1 font-semibold text-[25px]">Avaiable at</h1>
        ...
        <ul className="text-center sm:text-start">
          <h1 className="mb-1 font-semibold text-[25px]">Support</h1>
